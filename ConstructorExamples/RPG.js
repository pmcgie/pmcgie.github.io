...
function characterConstructor(name,profession,gender,age,strength,HP) {
    this.name = name;
    ...
    this.Attack = function(attackee) {
        return attackee.hp - this.strength
    }
...
var characterOne = new characterConstructor("Snoop","Folk-Singer","Male",30,100,80)
var characterTwo = new characterConstructor("Neo","banker","Male",80,30,10)
...
characterTwo.Attack(characterTwo)

characterOne.LevelUp()
characterTwo.LevelUp()
